...
{
    Q_GADGET
public: QCPItemAnchor(QCustomPlot *parentPlot, QCPAbstractItem *parentItem, const QString &name, int anchorId = -1);
...
{
    Q_OBJECT
    /// \cond INCLUDE_QPROPERTIES Q_PROPERTY(double width READ width WRITE setWidth)
...
{
    Q_OBJECT
public: QCPPolarLegendItem(QCPLegend *parent, QCPPolarGraph *graph);
