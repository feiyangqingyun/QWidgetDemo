...
void QCPGraph::setSmooth(int smooth)
{
    this->smooth = smooth;
}
...
void QCPGraph::drawFill(QCPPainter *painter, QVector<QPointF> *lineData) const
{
    ...
    if (!mChannelFillGraph) {
        ...
        if (smooth == 1) {
            painter->drawPath(SmoothCurve::createSmoothCurve(*lineData));
        } else if (smooth == 2) {
            painter->drawPath(SmoothCurve::createSmoothCurve2(*lineData));
        } else {
